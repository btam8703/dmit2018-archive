...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <asp:ObjectDataSource ID="ClientDataSource" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="ListClients" TypeName="ScheduleStarterKit.BLL.ContractController" />
            <h4>
        ...
        <div class="col-md-6">
            ...
            <asp:GridView ID="ClientContracts" runat="server" CssClass="table table-hover table-sm" 
                ItemType="ScheduleStarterKit.ViewModels.ContractInfo" DataKeyNames="ContractId" 
                AutoGenerateColumns="false" OnRowCommand="ClientContracts_RowCommand" OnSelectedIndexChanged="ClientContracts_SelectedIndexChanged">
                <Columns>
                    
                    <asp:ButtonField CommandName="Select" Text="Edit" ControlStyle-CssClass="btn btn-secondary btn-xs" />
                    <asp:TemplateField HeaderText="Title">
                        <ItemTemplate>
                            <asp:Label ID="Title" runat="server" Text="<%# Item.Title %>"></asp:Label>
                            <asp:Label ID="ContractID" runat="server" Visible ="false" Text="<%# Item.ContractId %>" ></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <asp:GridView ID="AvailableSkills" runat="server" CssClass="table table-hover table-sm" 
                ItemType="ScheduleStarterKit.ViewModels.SkillSummary" DataKeyNames="SkillId" 
                AutoGenerateColumns="false" OnRowCommand="AvailableSkills_RowCommand">
                <EmptyDataTemplate><i>No available skills</i></EmptyDataTemplate>
                <Columns>
                    <asp:TemplateField HeaderText="Description">
                        <ItemTemplate>
                            <asp:Label ID="SkillId" runat="server" Visible="false" Text="<%# Item.SkillId %>" />
        ...
        <div class="col-md-6">
            ...
            <asp:GridView ID="RequiredSkills" runat="server" CssClass="table table-hover table-sm" 
                ItemType="ScheduleStarterKit.ViewModels.SkillSummary" DataKeyNames="SkillId" 
                AutoGenerateColumns="false" OnRowCommand="RequiredSkills_RowCommand">
